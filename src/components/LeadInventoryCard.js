...
export default function LeadInventoryCard({
    propertyImg,
    property,
    address,
    society,
        ...
        <TouchableOpacity style={styles.card} onPress={navigation}>
            ...
            <View style={styles.detailsContainer}>
                <View style={{ flexDirection: 'row', justifyContent: 'space-between', width: '95%', alignItems: 'center', marginBottom: 10 }}>
                    <Text style={styles.houseName}>{shortenAddress(property)}</Text>
                    <TouchableOpacity onPress={openModal} style={{ width: '40%' }}>
                        {
                            viewStatus === "Inconsidration" ?
                                <View style={{ flexDirection: 'row', justifyContent: 'flex-end', alignItems: 'center' }}>
                                    ...
                                    <Image style={styles.eyesImage} source={require('../assets/images/consideraccept.png')} />
                                </View>
                                :
                                viewStatus === "Accepted" ?
                                    <View style={{ flexDirection: 'row', justifyContent: 'flex-end', alignItems: 'center' }}>
                                        <Text style={{ fontSize: 10, fontWeight: '500', color: "#1AFF55", marginRight: 10 }}>Accepted</Text>
                                        <Image style={styles.eyesImage} source={require('../assets/images/accept.png')} />
                                    </View>
                                    :
                                    viewStatus === "Rejected" ?
                                        <View style={{ flexDirection: 'row', justifyContent: 'flex-end', alignItems: 'center' }}>
                                            <Text style={{ fontSize: 10, fontWeight: '500', color: "#8068F7", marginRight: 10 }}>Rejected</Text>
                                            <Image style={styles.eyesImage} source={require('../assets/images/reject.png')} />
                                        </View>
                                        :
                                        <View style={{ flexDirection: 'row', justifyContent: 'flex-end', alignItems: 'center' }}>
                                            <Image style={styles.eyesImage} source={require('../assets/images/nonvisibility.png')} />
                                        </View>
                ...
                <Text style={styles.houseAddress}>{address}, {society}</Text>
                ...
                <View style={{ flexDirection: 'row', justifyContent: 'space-between', width: '95%', alignItems: 'center', marginBottom: 10, }}>
                    ...
                    {
                        viewStatus === "Accepted" ?
                            <TouchableOpacity onPress={navigation1} style={styles.btn}>
                    ...
                    {/* <TouchableOpacity style={{ marginTop: 10 }}>
                        <Icon1 name='heart-alt' color='#7D7F88' size={18} />
                    </TouchableOpacity> */}
                </View>
