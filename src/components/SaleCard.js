...
export default function SaleCard  ({ item })  {
    ...
    return (
        <View style={{ flex: 1, flexDirection: 'row', borderWidth: 1, borderColor: "#EBEBEB", borderRadius: 10, marginRight: RFValue(25) }}>
            <View style={{ flex: 0.3 }}>
                <Image style={{width:RFValue(100),height:RFValue(175)}} resizeMode='contain' source={require('../assets/images/Frame.png')} />
            </View>
            ...
            <View style={{ flex: 0.7, margin: RFValue(10), }}>
                ...
                <View style={{ flexDirection: 'row', marginTop: RFValue(10), alignItems: 'center' }}>
                    ...
                    <Icon3 name="home-export-outline" color="#7D7F88" size={20} />
