    ...
    return (
        <View style={HeaderStyle.mainContainer}>
            ...
            <View style={HeaderStyle.HeaderTextContainer}>
                <Text style={HeaderStyle.HeaderText}>Lead Tasks</Text>
...
export default function LeadTasks({navigation, route}) {
    ...
    const getLeadTasks = async() => {
        ...
        const response = await TaskApi.getLeadTasks(LeadID, role, businessID)
                ...
                <View style={{ flexDirection: "row", justifyContent: "space-between" }}>
                    ...
                    <View style={{ flex: 1, flexDirection: "row", justifyContent:"flex-end" }}>
                        ...
                        <TouchableOpacity
                            ...
                            onPress={()=>navigation.navigate('CreateLeadTasks', items)}
                        >
