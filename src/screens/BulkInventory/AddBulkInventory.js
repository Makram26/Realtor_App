...
export default function AddBulkInventory({ navigation }) {
    ...
    const addInventoryHandler = async () => {
        ...
        if (maxRange.match(regex) === null) {
            alert("Range must contain numbers only")
            setLoading(false)
            return true
        }
        ...
        //setLoading(true)
        // && houseName !== ""
        if (demand && demand !== "" && size && size !== ""  && societyName !== "") {
            for (let i = 0; i < parseInt(maxRange); i++) {
                setLoading(true)
                try {
                    await firestore()
    ...
    return (
        <View style={styles.screen}>
            ...
            <View style={styles.header}>
                ...
                <View>
                    <Text style={styles.headerText}>Add Bulk Inventory</Text>
                </View>
                <Image
            ...
            <ScrollView style={styles.body} showsVerticalScrollIndicator={false} keyboardShouldPersistTaps="always">
                ...
                <View style={transactionStyles.container}>
                    <Text style={transactionStyles.heading}>
                        {/* Transaction Type */}
                    </Text>
                ...
                <View style={{ width: "98%", flexDirection: "row", justifyContent: "space-between" }}>
                    ...
                    <View style={[propertyStyles.typeContainer, , { backgroundColor: '#917AFD' }]} >
                        <Text style={[propertyStyles.type, { color: 'white' }]}>Files</Text>
                    </View>
                </View>
                <View style={{ borderColor: '#E2E2E2', borderWidth: 1, marginVertical: 10 }} />
                ...
                <View style={{ wi: "92%", flexDirection: "row" }}>
                    {/* <View style={{ flex: 1, marginTop: 5 }}>
                        <Text style={{ fontSize: 15, fontWeight: "500", color: "#000000", marginLeft: 5 }}>From</Text>
                        <TextInput
                            placeholder='1'
                            style={{ backgroundColor: "white", color: "#7D7F88", justifyContent: 'center', borderRadius: 4, borderColor: "#BABCBF", borderWidth: 1, elevation: 2, height: 40, marginLeft: 5, marginTop: 5, paddingLeft: 10 }}
                            editable={false}
                        />
                    </View>
                    <View style={{ flex: 1, marginTop: 5 }}>
                        <Text style={{ fontSize: 15, fontWeight: "500", color: "#000000", marginLeft: 5 }}>To</Text>
                        <TextInput
                            placeholder='1'
                            keyboardType="numeric"
                            value={maxRange}
                            onChangeText={(val)=> setMaxRange(val)}
                            style={{ backgroundColor: "white", color: "#7D7F88", justifyContent: 'center', borderRadius: 4, borderColor: "#BABCBF", borderWidth: 1, elevation: 2, height: 40, marginLeft: 5, marginTop: 5, paddingLeft: 10 }}
                        />
                    </View> */}

                    <View style={[styles.demandContainer, {width: "100%"}]}>
                        <TextInput
                            placeholder='Enter No. of Files here...'
                            placeholderTextColor="#1A1E25"
                            style={styles.demandInput}
                            // onBlur={() =>  LostFocus(demand)}
                            keyboardType='numeric'
                ...
                <View style={{ borderColor: '#E2E2E2', borderWidth: 1, marginVertical: 10, marginTop: 20 }} />
            ...
            <Modal visible={modalOpen} animationType='slide'>
                <View style={{ flex: 1, backgroundColor: "#ffffff" }}>
                    ...
                    <View style={[styles.placeFindContainer, { width: "95%", alignSelf:'center' }]}>
                        <Icon
                            name='location'
                            color="#917AFD"
                            size={25}
