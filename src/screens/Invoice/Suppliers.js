...
export default function Suppliers({ route, navigation }) {
        ...
        <View style={{ flex: 1, backgroundColor: "#FCFCFC" }}>
            ...
            <View style={HeaderStyle.mainContainer}>
                ...
                <View style={HeaderStyle.HeaderTextContainer}>
                    <Text style={HeaderStyle.HeaderText}>Suppliers</Text>
            ...
            <View style={{ width: "92%", justifyContent: "center", margin: 15, alignItems: 'flex-end' }}>
                ...
                >
                    <Text style={{ color: '#8A73FB', fontSize: 12, fontWeight: '500' }}>New Supplier</Text>
                </TouchableOpacity>
            </View>
            ...
            {/* Invoice Done */}
            {
                invoiceUserRecord.length < 1 ?
                    <View >
                        <Text style={styles.emptyUserRecord}>You do not have any Supplier!</Text>
                    </View>
                    :
                    <FlatList
